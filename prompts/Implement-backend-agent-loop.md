# Session: Implement backend agent loop

**Session ID:** ses_16f76f1c0ffeB8OJ7SQHzgWo2r
...
```text
Implement the agent loop in backend/ as defined in @Technical Assessment (1).html 
```
...
The text the user typed after `/speckit.specify` in the triggering message **is** the feature description. Assume you always have it available in this conversation even if `Implement the agent loop in backend/ as defined in @Technical Assessment (1).html ` appears literally below. Do not ask the user to repeat it unless they provided an empty command.
...
**Short name**: `agent-loop`

**Before-specify hook** (mandatory):
